...
const ProductList: React.FC = () => {
        ...
        { title: 'Description', dataIndex: 'description', key: 'description' },
        {
            ...
            render: (_, product) => (
                <div>
                    ...
                    <a style={{ color: 'red' }} onClick={() => mutation.mutate(product.id)}>
                        <DeleteOutlined />
                    </a>
                </div>
            ),
    ...
    const prepareData = data.map((product: TProduct, index: number) => ({
        ...product,
        key: product.id,
        index: index + 1
    }))
    ...
    return (
        <div>
            ...
            <Table
                columns={columns}
                dataSource={prepareData}  // Replace with actual data
                expandable={{
